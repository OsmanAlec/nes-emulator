...
pub fn trace(cpu: &mut CPU) -> String {
    ...
    let tmp = match ops.bytes {
        ...
        2 => {
            ...
            match ops.mode {
                ...
                _ => panic!(
                    "unexpected addressing mode {:?} has ops-bytes 2. code {:02x}",
                    ops.mode, ops.code
                ),
            }
        }
        3 => {
            ...
            match ops.mode {
                ...
                _ => panic!(
                    "unexpected addressing mode {:?} has ops-bytes 3. code {:02x}",
                    ops.mode, ops.code
                ),
            }
        }
    ...
    format!(
        ...
        asm_str, cpu.register_a, cpu.register_x, cpu.register_y, cpu.register_p, cpu.stack_pointer,
    )
    .to_ascii_uppercase()
}
...
mod test {
    ...
    fn test_format_trace() {
        let mut bus = Bus::new(test_rom(), |_ppu, _joypad, _joypad2| {});
